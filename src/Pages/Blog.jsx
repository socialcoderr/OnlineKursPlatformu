...
export default function Blog() {
  return (
    <>
      <section id="page-banner" className="pt-105 pb-130 bg_cover" data-overlay="8" style={{backgroundImage: "url(images/page-banner-1.jpg)"}}>
                    ...
                    <div className="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active" aria-current="page">Few tips for get better</li>
                            </ol>
                        </nav>
                    </div>  
                </div>
              ...
              <div className="col-lg-8">
                  <div className="blog-details mt-30">
                      ...
                      <div className="cont">
                          ...
                          <ul>
                               <li><a href="#"><i className="fa fa-calendar"></i>25 Dec 2018</a></li>
                               <li><a href="#"><i className="fa fa-user"></i>Mark anthem</a></li>
                               <li><a href="#"><i className="fa fa-tags"></i>Education</a></li>
                           </ul>
